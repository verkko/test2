...
use App\Http\Controllers\API\Device\AppointmentScheduleController;
use App\Http\Controllers\API\Device\AppointmentSlotController;
use App\Http\Controllers\API\Device\AuthController;
use App\Http\Controllers\API\Device\BlogController;
use App\Http\Controllers\API\Device\ChatGroupController;
use App\Http\Controllers\API\Device\ChatMessageController;
use App\Http\Controllers\API\Device\CommentController;
use App\Http\Controllers\API\Device\CustomerController;
use App\Http\Controllers\API\Device\DepartmentsController;
use App\Http\Controllers\API\Device\EncounterController;
use App\Http\Controllers\API\Device\EnterpriseController;
use App\Http\Controllers\API\Device\EventController;
use App\Http\Controllers\API\Device\MasterController;
use App\Http\Controllers\API\Device\MedicationController;
use App\Http\Controllers\API\Device\NoteController;
use App\Http\Controllers\API\Device\OrderController;
use App\Http\Controllers\API\Device\OrderItemController;
use App\Http\Controllers\API\Device\PatientController;
use App\Http\Controllers\API\Device\PlanController;
use App\Http\Controllers\API\Device\TaskController;
use App\Http\Controllers\API\Device\ToDoController;
